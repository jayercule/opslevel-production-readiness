...
| **Chaos engineering**  | Once the applications have proven the ability to stand up to load and stress, the team integrates chaos engineering to identify weak points and opportunities to reduce failures  |   | | | 
...
|   | Complete manual DAST or pen testing runs according to the security requirements of the service or company
  | Important  | | | 
